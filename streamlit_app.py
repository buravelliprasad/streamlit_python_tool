...
from pydantic import BaseModel, Field
# from my_module import PythonAstREPLTool  # Replace 'my_module' with the actual module where PythonAstREPLTool is defined
import pandas as pd
...
repl = PythonAstREPLTool(
        ...
        args_schema=python_inputs  # Use the instance you created
    )
